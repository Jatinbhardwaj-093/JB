...
<template>
  ...
  >
    <p class="font-bold text-xl sm:text-3xl md:text-3xl lg:text-4xl mt-6 mb-4 leading-tight py-2 px-2 rounded-md bg-gray-100/70 dark:bg-gray-900/40 w-full">
      GSoC-25: Weeks 8, 9, 10
    </p>
    <p class="mb-3 sm:mb-4 text-sm sm:text-base md:text-base lg:text-lg leading-6 sm:leading-7 md:leading-7 tracking-[0.01em] sm:tracking-[0.015em] text-wrap-pretty max-w-full sm:max-w-[95%] md:max-w-[90%]">
    ...
    <p class="mb-3 sm:mb-4 text-sm sm:text-base md:text-base lg:text-lg leading-6 sm:leading-7 md:leading-7 tracking-[0.01em] sm:tracking-[0.015em] text-wrap-pretty max-w-full sm:max-w-[95%] md:max-w-[90%]">
      The main PR <a href="https://github.com/sympy/sympy/pull/28109" class="text-blue-600 dark:text-blue-400 underline">gh-28109</a> was merged in the middle of week 8, which officially made the Series Module available in the main <code>master</code> branch.
    </p>
    <p class="mb-3 sm:mb-4 text-sm sm:text-base md:text-base lg:text-lg leading-6 sm:leading-7 md:leading-7 tracking-[0.01em] sm:tracking-[0.015em] text-wrap-pretty max-w-full sm:max-w-[95%] md:max-w-[90%]">
      For the follow-up PR, I needed to add transcendental functions to provide algorithms for their series expansions. This was done in PR <a href="https://github.com/sympy/sympy/pull/28273" class="text-blue-600 dark:text-blue-400 underline">gh-28273</a>. This PR also contains some other work that was left in gh-28109—such as adding a method for series precision, separating the protocol, and optimizing the routine of <code>unify_prec</code>. It also increases the current test coverage of the whole module.
    </p>
    <p class="mb-3 sm:mb-4 text-sm sm:text-base md:text-base lg:text-lg leading-6 sm:leading-7 md:leading-7 tracking-[0.01em] sm:tracking-[0.015em] text-wrap-pretty max-w-full sm:max-w-[95%] md:max-w-[90%]">
      This has also been merged into master a few days back—with the help of other supporting PRs: <a href="https://github.com/sympy/sympy/pull/28281" class="text-blue-600 dark:text-blue-400 underline">gh-28281</a>, <a href="https://github.com/sympy/sympy/pull/28283" class="text-blue-600 dark:text-blue-400 underline">gh-28283</a>, and <a href="https://github.com/sympy/sympy/pull/28293" class="text-blue-600 dark:text-blue-400 underline">gh-28293</a>.
    </p>
    <p class="mb-3 sm:mb-4 text-sm sm:text-base md:text-base lg:text-lg leading-6 sm:leading-7 md:leading-7 tracking-[0.01em] sm:tracking-[0.015em] text-wrap-pretty max-w-full sm:max-w-[95%] md:max-w-[90%]">
    ...
    <h2 class="font-bold text-lg sm:text-xl md:text-2xl mb-3 mt-6">Some Examples of How to Use the Poly/Series Module of SymPy</h2>
...
R.print(R.tan(R.gen))
    ...
    <h2 class="font-bold text-lg sm:text-xl md:text-2xl mb-3 mt-6">Next Steps From Here</h2>
    <p class="mb-3 sm:mb-4 text-sm sm:text-base md:text-base lg:text-lg leading-6 sm:leading-7 md:leading-7 tracking-[0.01em] sm:tracking-[0.015em] text-wrap-pretty max-w-full sm:max-w-[95%] md:max-w-[90%]">
      Now, what I would like to do is wrap these classes in an upper-level domain ring. This way, it won't be necessary to import different types of rings for different ground domains. What we want is to provide the ground domain as a parameter, which will internally create the ring automatically using the correct class—similar to what the PolyRing does in SymPy and like our <code>power_series_ring</code> factory function.
    </p>
    <p class="mb-3 sm:mb-4 text-sm sm:text-base md:text-base lg:text-lg leading-6 sm:leading-7 md:leading-7 tracking-[0.01em] sm:tracking-[0.015em] text-wrap-pretty max-w-full sm:max-w-[95%] md:max-w-[90%]">
