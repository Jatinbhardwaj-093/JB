...
It checks for equality up to the shared truncation precision, returns False if a conflict is found, and None if values match but further terms are unknown.`;export{e as default};
